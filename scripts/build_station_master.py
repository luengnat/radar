...
def tmd_event(record: dict[str, Any]) -> dict[str, Any]:
    ...
    values = {
        "fiscal_year_be": record.get("fiscal_year_be"), "activity_class": record.get("activity_class"), "scope": record.get("station_or_scope"), "radar_band": record.get("radar_band"), "description": record.get("description"), "procurement_method": record.get("procurement_method"), "budget_baht": record.get("budget_baht"), "reference_price_baht": record.get("reference_price_baht"), "submitted_bids": record.get("bids"), "winner": record.get("selected_supplier"), "contract_value_baht": record.get("contract_value_baht"), "contract_number": record.get("contract_number"), "contract_date_be": record.get("contract_date_be"), "winner_notice_date_be": record.get("winner_notice_date_be"), "contract_status": record.get("contract_status"), "project_id": record.get("project_id"), "evidence_status": record.get("evidence_status"), "review_note": record.get("review_note"), "official_source_url": record.get("official_source_url"),
    }
